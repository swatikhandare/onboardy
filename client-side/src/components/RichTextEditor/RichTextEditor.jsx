...
import UnderlinedIcon from './icons/underline.icon'
import CodeIcon from './icons/code.icon'
import QuoteIcon from './icons/quote.icon'
import OlListIcon from './icons/olList.icon'
import UlListIcon from './icons/ulList.icon'
  ...
  return (
    <Slate editor={editor} value={initialValue}>
      <div style={{ display: "flex", alignItems: "center", gap: "5px", justifyContent: "center"}}>
        ...
        <BlockButton format="numbered-list" icon={<OlListIcon />} />
        <BlockButton format="bulleted-list" icon={<UlListIcon />} />
